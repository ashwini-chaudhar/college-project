...
<body background="img\background\bdbg.jpg" style="background-size:100%;background-position: fixed;">
...
<div>
  <h4><b><center>!..BRING A COPY OF YOR RECEIPT WITH YOU..!</center></b></h4>
...
<div class="container-fluid py-5 my-5">
  <table border=2 class="text-center">
    ...
    <?php
      include 'isLogin.php';
      $sql="SELECT * FROM bookingshoney WHERE usr_id='".$id."'";
      $result=$conn->query($sql);
      while ($row=$result->fetch_assoc()) 
      {
        $sql1="SELECT * FROM addhoney WHERE id='".$row['placeid']."'";
...
<div>
  <h4><b><center>THANK YOU FOR BOOKING!!!</center></b></h4>
  <h4><b><center>!!!visit again!!!</center></b></h4>
</div>
