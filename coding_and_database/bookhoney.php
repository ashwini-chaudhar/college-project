...
<html>
<head>
  <title>book honeymoon pack</title>
...
if ($_SERVER['REQUEST_METHOD']=='GET') 
{
  ...
  if(isset($_SESSION['login_user']) && isset($_SESSION['pid']) && isset($_GET['noRoom']))
  {
    ...
    $sql1="INSERT INTO bookingshoney (usr_id,placeid,arvPlace,date,noOfPerson,noOfChild,name,mno,address,gender,noRoom) VALUES('".$id."','".$_SESSION['pid']."','$arvPlace','".$date."','".$noOfPerson."','".$numOfChild."','".$name."','".$mno."','".$address."','".$gender."','".$noRoom."')";

    if($conn->query($sql1)===TRUE)
    {
      header('Location: bookdetailhoney.php');
    }
  }
}
?> 
