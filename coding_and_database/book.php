...
if ($_SERVER['REQUEST_METHOD']=='GET') 
{
  ...
  if(isset($_SESSION['login_user']) && isset($_SESSION['pid']) && isset($_GET['noRoom']))
  {
    ...
    $sql1="INSERT INTO bookings (usr_id,placeid,arvPlace,date,noOfPerson,noOfChild,name,mno,address,gender,noRoom) VALUES('".$id."','".$_SESSION['pid']."','$arvPlace','".$date."','".$noOfPerson."','".$numOfChild."','".$name."','".$mno."','".$address."','".$gender."','".$noRoom."')";
