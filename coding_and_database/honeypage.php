...
<body background="img\background\hbg.jpg" style="background-size:100%;background-position: fixed;">
    ...
    <h3>Categories:</h3>
      ...
      <div class="col-lg-8">
          ...
          <div class="carousel-item active">
           ...
           <img class="d-block img-fluid" href src="img\honey1.jpg" style="border:5px solid black;height:25rem;width:50rem";alt="first slide">
          ...
          <img class="d-block img-fluid" href src="img\honey2.jpg" style="border:5px solid black;height:25rem;width:50rem";alt="Second slide">
          </div>
          <div class="carousel-item">

               <img class="d-block img-fluid" href src="img\honey3.jpg" style="border:5px solid black;height:25rem;width:50rem";alt="Third slide">
          </div>
          </div>
      ...
      <h2><B>GUIDE + FOOD(VEG + NON-VEG) FREE OF COST</B></h2>
    </div>
  </div>
</div>
         ...
         while($row=$result->fetch_assoc())
           {
            ...
            <div class="col-3 mb-3">
              <div class="card" style="border:5px solid black;">
                <div class="card-body">
                  <a href="insidehoney.html"><img class="card-img-top" href src="<?php echo $img;?>" style="height:17rem;width:15rem;"></a>
                  ...
                  <a class="btn btn-primary btn-md btn-block" href="isLoginhoney.php?q=<?php echo $id;?>">Book</a>
              </div>
            </div>
          </div>
